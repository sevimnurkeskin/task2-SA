...
/**
 * Pipeline filter that routes {@link NPathComplexityCheck} exclusively through
 * the check pipeline.  All check logic remains in the original class; this
 * wrapper only handles lifecycle delegation.
 */
public final class NPathComplexityFilter extends AbstractAstCheckFilter {
     ...
     */
    public NPathComplexityFilter(NPathComplexityCheck check) {
        super(check);
    }
