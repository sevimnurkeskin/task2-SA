...
/**
 * Pipeline filter that routes {@link OuterTypeNumberCheck} exclusively through
 * the check pipeline.  All check logic remains in the original class; this
 * wrapper only handles lifecycle delegation.
 */
public final class OuterTypeNumberFilter extends AbstractAstCheckFilter {
     ...
     */
    public OuterTypeNumberFilter(OuterTypeNumberCheck check) {
        super(check);
    }
