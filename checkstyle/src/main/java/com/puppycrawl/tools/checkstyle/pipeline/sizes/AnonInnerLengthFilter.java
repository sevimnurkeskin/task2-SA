...
/**
 * Pipeline filter that routes {@link AnonInnerLengthCheck} exclusively through
 * the check pipeline. All check logic remains in the original class; this
 * wrapper only handles lifecycle delegation.
 */
public final class AnonInnerLengthFilter extends AbstractAstCheckFilter {
     ...
     */
    public AnonInnerLengthFilter(AnonInnerLengthCheck check) {
        super(check);
    }
