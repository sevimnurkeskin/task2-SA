...
/**
 * Pipeline filter that routes {@link ParameterNumberCheck} exclusively through
 * the check pipeline.  All check logic remains in the original class; this
 * wrapper only handles lifecycle delegation.
 */
public final class ParameterNumberFilter extends AbstractAstCheckFilter {
     ...
     */
    public ParameterNumberFilter(ParameterNumberCheck check) {
        super(check);
    }
