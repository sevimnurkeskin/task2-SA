...
/**
 * Pipeline filter that routes {@link LambdaBodyLengthCheck} exclusively through
 * the check pipeline. All check logic remains in the original class; this
 * wrapper only handles lifecycle delegation.
 */
public final class LambdaBodyLengthFilter extends AbstractAstCheckFilter {
     ...
     */
    public LambdaBodyLengthFilter(LambdaBodyLengthCheck check) {
        super(check);
    }

    @Override
    public String getName() {
        return "LambdaBodyLength";
    }
